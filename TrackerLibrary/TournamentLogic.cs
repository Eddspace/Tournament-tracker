...
public static class TournamentLogic
{
    ...
    // create every round after thatl
    ...
    private static void CompleteTournament(TournamentModel model)
    {
        ...
        body.AppendLine("<p>Congratulations to our winner of our great tournament</p>");
        body.AppendLine("<br />");
    ...
    private static void MarkWinnerInMatchups(List<MatchupModel> models)
    {
        ...
        foreach (MatchupModel m in models)
        {
            ...
            if (greaterWins == "0")
            {
                ...
                {
                    throw new Exception("We do not allow ties in this Tournament Tracker.");
                }
            }
            else
            {
